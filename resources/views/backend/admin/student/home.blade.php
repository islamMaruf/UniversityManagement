    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box">
                        <h6 class="m-t-0">Enter Student information</h6>
                        <span class="text-success ">{{Session::get('msg')}}</span>
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" method="post" role="form" action="{{route('admin.submitStudent')}}">
                                        @csrf
                                        <div class="form-group">
                                            <label class="col-lg-12 col-form-label">Enter Student name</label>
                                            <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                    <div class="card-box">
                        <div class="m-b-20">
                            <h6 class="m-t-0 mb-3">All Student information</h6>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box">
                        <h6 class="m-t-0">Add Course to student</h6>
                        <span class="text-success ">{{Session::get('mess')}}</span>
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" method="post" role="form" action="{{route('admin.submitStudentCourse')}}">
                                        @csrf
                                        <div class="form-group">
                        ...
                        <div class="m-b-20">
                            ...
                            <tr class="text-body">
                                ...
                                <td>
                                    ...
                                    <input type="button" class="btn btn-danger  mb-2" value="Delete">
